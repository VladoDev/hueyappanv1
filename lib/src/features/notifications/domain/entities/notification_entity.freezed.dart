...
@override
String toString() {
  return 'NotificationEntity(id: $id, title: $title, body: $body, type: $type, data: $data, createdAt: $createdAt, isRead: $isRead)';
}
...
class _NotificationEntity implements NotificationEntity {
  const _NotificationEntity({required this.id, required this.title, required this.body, required this.type, required final  Map<String, dynamic> data, required this.createdAt, required this.isRead}): _data = data;
