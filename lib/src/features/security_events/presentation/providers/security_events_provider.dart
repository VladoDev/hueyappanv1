...
final securityEventsDatasourceProvider = Provider<SecurityEventsFirebaseDatasource>((ref) {
  return SecurityEventsFirebaseDatasource();
});

final securityEventsRepositoryProvider = Provider<SecurityEventsRepository>((ref) {
