...
mixin _$ResidentModel {
 ...
 String get uid; String get name; String get email; String get lot; String get house; String get accountStatus; String? get phone; String? get residentType; String get role; bool get isPhoneVerified; String? get deviceId;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,uid,name,email,lot,house,accountStatus,phone,residentType,role,isPhoneVerified,deviceId);

@override
String toString() {
  return 'ResidentModel(uid: $uid, name: $name, email: $email, lot: $lot, house: $house, accountStatus: $accountStatus, phone: $phone, residentType: $residentType, role: $role, isPhoneVerified: $isPhoneVerified, deviceId: $deviceId)';
}
...
@useResult
$Res call({
 String uid, String name, String email, String lot, String house, String accountStatus, String? phone, String? residentType, String role, bool isPhoneVerified, String? deviceId
});
...
/// Create a copy of ResidentModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? uid = null,Object? name = null,Object? email = null,Object? lot = null,Object? house = null,Object? accountStatus = null,Object? phone = freezed,Object? residentType = freezed,Object? role = null,Object? isPhoneVerified = null,Object? deviceId = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String uid,  String name,  String email,  String lot,  String house,  String accountStatus,  String? phone,  String? residentType,  String role,  bool isPhoneVerified,  String? deviceId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ResidentModel() when $default != null:
return $default(_that.uid,_that.name,_that.email,_that.lot,_that.house,_that.accountStatus,_that.phone,_that.residentType,_that.role,_that.isPhoneVerified,_that.deviceId);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String uid,  String name,  String email,  String lot,  String house,  String accountStatus,  String? phone,  String? residentType,  String role,  bool isPhoneVerified,  String? deviceId)  $default,) {final _that = this;
switch (_that) {
case _ResidentModel():
return $default(_that.uid,_that.name,_that.email,_that.lot,_that.house,_that.accountStatus,_that.phone,_that.residentType,_that.role,_that.isPhoneVerified,_that.deviceId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String uid,  String name,  String email,  String lot,  String house,  String accountStatus,  String? phone,  String? residentType,  String role,  bool isPhoneVerified,  String? deviceId)?  $default,) {final _that = this;
switch (_that) {
case _ResidentModel() when $default != null:
return $default(_that.uid,_that.name,_that.email,_that.lot,_that.house,_that.accountStatus,_that.phone,_that.residentType,_that.role,_that.isPhoneVerified,_that.deviceId);case _:
  return null;
...
class _ResidentModel implements ResidentModel {
  const _ResidentModel({required this.uid, required this.name, required this.email, this.lot = '', this.house = '', required this.accountStatus, this.phone, this.residentType, this.role = 'vecino', this.isPhoneVerified = false, this.deviceId});
...
/// Create a copy of ResidentModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? uid = null,Object? name = null,Object? email = null,Object? lot = null,Object? house = null,Object? accountStatus = null,Object? phone = freezed,Object? residentType = freezed,Object? role = null,Object? isPhoneVerified = null,Object? deviceId = freezed,}) {
